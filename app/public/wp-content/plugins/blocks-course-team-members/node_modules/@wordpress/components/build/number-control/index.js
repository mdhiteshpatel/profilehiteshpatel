...
function NumberControl(_ref, ref) {
  ...
  const numberControlStateReducer = (state, action) => {
    ...
    if (type === inputControlActionTypes.DRAG && isDragEnabled) {
      ...
      if (delta !== 0) {
        ...
        state.value = constrainValue((0, _math.add)(currentValue, distance), enableShift ? modifier : null);
      }
    }
    /**
  ...
  return (0, _element.createElement)(_numberControlStyles.Input, (0, _extends2.default)({
    ...
    type: typeProp,
    value: valueProp,
    __unstableStateReducer: (0, _reducer.composeStateReducers)(numberControlStateReducer, stateReducer)
  }));
}
