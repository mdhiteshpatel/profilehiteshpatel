...
exports.withBlockContentContext = exports.default = void 0;
...
const BlockContentProvider = _ref => {
  ...
  const BlockContent = () => {
    ...
    const html = (0, _api.serialize)(innerBlocks, {
      isInnerBlocks: true
...
const withBlockContentContext = (0, _compose.createHigherOrderComponent)(OriginalComponent => {
  return props => (0, _element.createElement)(Consumer, null, context => (0, _element.createElement)(OriginalComponent, (0, _extends2.default)({}, props, {
