...
var _constants2 = require("../api/constants");
...
function processBlockType(blockType) {
  ...
  if (settings.deprecated) {
    ...
    { // Omit deprecation keys here so that deprecations
      ...
      ...(0, _lodash.omit)(blockType, _constants2.DEPRECATED_ENTRY_KEYS),
      ...deprecation
    }, name), _constants2.DEPRECATED_ENTRY_KEYS));
  }
  ...
  if ('category' in settings && !(0, _lodash.some)((0, _data.select)(_constants.STORE_NAME).getCategories(), {
...
function* __experimentalReapplyBlockTypeFilters() {
  const unprocessedBlockTypes = (0, _data.select)(_constants.STORE_NAME).__experimentalGetUnprocessedBlockTypes();
