...
const withBlockTree = reducer => (state = {}, action) => {
  ...
  switch (action.type) {
    ...
    case 'REMOVE_BLOCKS_AUGMENTED_WITH_CHILDREN':
      ...
      newState.tree = updateParentInnerBlocksInTree(newState, (0, _lodash.omit)(newState.tree, action.removedClientIds.concat(action.removedClientIds.map(clientId => 'controlled||' + clientId))), parentsOfRemovedBlocks);
      break;
...
const withBlockReset = reducer => (state, action) => {
  if (action.type === 'RESET_BLOCKS') {
    ...
    const controlledInnerBlocks = Object.keys((0, _lodash.pickBy)((_state$controlledInne2 = state === null || state === void 0 ? void 0 : state.controlledInnerBlocks) !== null && _state$controlledInne2 !== void 0 ? _state$controlledInne2 : {}));
    /**
    ...
    const newState = { ...state,
      byClientId: { ...(0, _lodash.omit)(state === null || state === void 0 ? void 0 : state.byClientId, visibleClientIds),
        ...getFlattenedBlocksWithoutAttributes(action.blocks)
      },
      attributes: { ...(0, _lodash.omit)(state === null || state === void 0 ? void 0 : state.attributes, visibleClientIds),
        ...getFlattenedBlockAttributes(action.blocks)
      },
      order: { ...(0, _lodash.omit)(state === null || state === void 0 ? void 0 : state.order, visibleClientIds),
        ...(0, _lodash.omit)(mapBlockOrder(action.blocks), controlledInnerBlocks)
      },
      parents: { ...(0, _lodash.omit)(state === null || state === void 0 ? void 0 : state.parents, visibleClientIds),
        ...mapBlockParents(action.blocks)
      },
      controlledInnerBlocks: (state === null || state === void 0 ? void 0 : state.controlledInnerBlocks) || {}
    };
    const subTree = buildBlockTree(newState, action.blocks);
    newState.tree = { ...(0, _lodash.omit)(state === null || state === void 0 ? void 0 : state.tree, visibleClientIds),
      ...subTree,
      // Root
      '': {
