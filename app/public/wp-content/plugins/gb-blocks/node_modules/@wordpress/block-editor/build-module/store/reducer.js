 ...
 */
import { flow, reduce, first, last, omit, without, mapValues, keys, isEqual, isEmpty, identity, omitBy, pickBy } from 'lodash';
/**
...
const withBlockTree = reducer => (state = {}, action) => {
  ...
  switch (action.type) {
    ...
    case 'REPLACE_BLOCKS_AUGMENTED_WITH_CHILDREN':
      {
        const subTree = buildBlockTree(newState, action.blocks);
        newState.tree = updateParentInnerBlocksInTree(newState, { ...omit(newState.tree, action.replacedClientIds.concat(action.replacedClientIds.map(clientId => 'controlled||' + clientId))),
          ...subTree
    ...
    case 'REMOVE_BLOCKS_AUGMENTED_WITH_CHILDREN':
      ...
      newState.tree = updateParentInnerBlocksInTree(newState, omit(newState.tree, action.removedClientIds.concat(action.removedClientIds.map(clientId => 'controlled||' + clientId))), parentsOfRemovedBlocks);
      break;
...
const withBlockReset = reducer => (state, action) => {
  if (action.type === 'RESET_BLOCKS') {
    ...
    const controlledInnerBlocks = Object.keys(pickBy((_state$controlledInne2 = state === null || state === void 0 ? void 0 : state.controlledInnerBlocks) !== null && _state$controlledInne2 !== void 0 ? _state$controlledInne2 : {}));
    /**
    ...
    const newState = { ...state,
      byClientId: { ...omit(state === null || state === void 0 ? void 0 : state.byClientId, visibleClientIds),
        ...getFlattenedBlocksWithoutAttributes(action.blocks)
      },
      attributes: { ...omit(state === null || state === void 0 ? void 0 : state.attributes, visibleClientIds),
        ...getFlattenedBlockAttributes(action.blocks)
      },
      order: { ...omit(state === null || state === void 0 ? void 0 : state.order, visibleClientIds),
        ...omit(mapBlockOrder(action.blocks), controlledInnerBlocks)
      },
      parents: { ...omit(state === null || state === void 0 ? void 0 : state.parents, visibleClientIds),
        ...mapBlockParents(action.blocks)
      },
      controlledInnerBlocks: (state === null || state === void 0 ? void 0 : state.controlledInnerBlocks) || {}
    };
    const subTree = buildBlockTree(newState, action.blocks);
    newState.tree = { ...omit(state === null || state === void 0 ? void 0 : state.tree, visibleClientIds),
      ...subTree,
      // Root
      '': {
