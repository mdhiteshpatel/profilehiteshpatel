...
const getInserterItems = (0, _rememo.default)((state, rootClientId = null) => {
  ...
  const buildReusableBlockInserterItem = reusableBlock => {
    ...
    return {
      ...
      icon: referencedBlockType && _element.Platform.OS === 'web' ? referencedBlockType.icon : _icons.symbol,
      category: 'reusable',
      keywords: [],
      isDisabled: false,
      utility: 1,
