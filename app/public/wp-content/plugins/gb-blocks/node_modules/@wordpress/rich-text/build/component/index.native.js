...
class RichText extends _element.Component {
  ...
  getFontSize() {
    ...
    if (baseGlobalStyles !== null && baseGlobalStyles !== void 0 && (_baseGlobalStyles$typ = baseGlobalStyles.typography) !== null && _baseGlobalStyles$typ !== void 0 && _baseGlobalStyles$typ.fontSize) {
  ...
  getLineHeight() {
    ...
    let lineHeight; // eslint-disable-next-line no-undef

    if (!__DEV__) {
      return;
    }

    if (baseGlobalStyles !== null && baseGlobalStyles !== void 0 && (_baseGlobalStyles$typ3 = baseGlobalStyles.typography) !== null && _baseGlobalStyles$typ3 !== void 0 && _baseGlobalStyles$typ3.lineHeight) {
      var _baseGlobalStyles$typ4;

      lineHeight = parseFloat(baseGlobalStyles === null || baseGlobalStyles === void 0 ? void 0 : (_baseGlobalStyles$typ4 = baseGlobalStyles.typography) === null || _baseGlobalStyles$typ4 === void 0 ? void 0 : _baseGlobalStyles$typ4.lineHeight);
    }
